  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      ...
      <h1 className="mt-1 text-4xl font-black text-navy md:text-5xl">
        Why students choose LYF SAVER
      </h1>
      <div className="mt-8 grid gap-8 md:grid-cols-[1fr_auto] md:items-start">
        <div className="space-y-4 text-muted-foreground">
          <p>
            LYF SAVER started because we've been there. Final year comes with placement stress,
            backlogs, fests, family — and a project deadline that just won't move. Every vendor
            quotes too high, every "senior" is too busy, and college guides expect a report that
            could double as a book.
          </p>
          <p>
            We're a small team of engineers and designers who've shipped 500+ final year projects
            across CSE, ISE, AIML, Data Science, CSBS and Electronics. We build clean, working
            projects — with reports and PPTs your guide will actually approve — and we price them
            lower than whatever quote you've been given elsewhere.
          </p>
          <p>
      ...
      <div className="mt-12 text-center">
        <Link
          to="/contact"
          className="inline-block rounded-full bg-navy px-6 py-3 text-sm font-semibold text-primary-foreground shadow-card"
        >
          Work with us
        </Link>
      </div>
